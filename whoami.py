...
1. Упала интенсивность атаки.
 ...
 Так происходит из-за того, что сервисы добавляют ваш ip в чёрный список из-за слишком большого кол-ва запросов.
...
3. Утилита неисправна или работает неккоректно.
 Переустановите или ждите, пока дядя разработчик всё пофиксит.
'''))
