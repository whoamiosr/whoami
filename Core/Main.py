...
def main(page: Page):
    ...
    def color_change(e):
        ...
        global color
        color = choice(_color)
        banner.controls = [Text(spans=[TextSpan('PIDOR', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('PIDOR', TextStyle(size=95, color=color))], font_family='Consolas')]
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('PIDOR', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('PIDOR', TextStyle(size=95, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='telegram', icon_size=48, tooltip='Мой тг ёпта наху', url='https://t.me/tokioni', icon_color=color),
                    IconButton(icon='info', icon_size=48, tooltip='Информация', icon_color=color, on_click=information),
                    IconButton(icon='color_lens_sharp', icon_size=48, tooltip='Цвет (рандом)', icon_color=color, on_click=color_change),
